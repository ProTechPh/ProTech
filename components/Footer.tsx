        ...
        <div className={styles.footerContent}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.brandDescription}>
              Transforming ideas into cutting-edge digital experiences with innovation and excellence.
            </p>
          ...
          <div className={styles.footerLinks}>
            ...
            <div className={styles.footerColumn}>
              ...
              <ul>
                <li>
                  <a href="mailto:jerickogarcia0@gmail.com">
                    jerickogarcia0@gmail.com
                  </a>
                </li>
                <li>
                  <a href="https://www.facebook.com/profile.php?id=61574105611075" target="_blank" rel="noopener noreferrer">
                    Facebook Page
                  </a>
                </li>
